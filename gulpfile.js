...
const path = {
	src: {
		...
		jsFiles: ['frontend/js/plugins.js', 'frontend/js/admin.js'],
...
gulp.task('watch', function () {
	...
	gulp.watch('frontend/img/icons/', gulp.series('svgsprite', 'templates'));
...
gulp.task('default', gulp.series('clean', 'html', 'less', 'js', 'js:files', 'img', 'fonts', 'svgsprite', 'templates', 'blocks', 'functions', 'languages', 'css', 'watch'));
gulp.task('min', gulp.series('clean', 'html:min', 'theme-style-copy', 'less:min', 'js:min', 'js:files:min', 'img', 'fonts', 'svgsprite', 'templates', 'blocks', 'functions', 'languages', 'css'));
gulp.task('build', gulp.series('clean', 'html', 'less:build', 'js:build', 'js:files', 'img', 'fonts', 'svgsprite', 'templates', 'blocks', 'functions', 'languages', 'css'));